...
def main():
    ...
    parser = argparse.ArgumentParser(description="Reasoning Agent with multiple AI backends")
    parser.add_argument("--backend", choices=["auto", "together", "ollama"], 
                       default="auto", help="AI backend to use (default: auto)")
